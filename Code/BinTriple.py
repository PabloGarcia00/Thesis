...
from Model import ComboBreaker, Transformer, OptimizationModel
import numpy as np 
import os 
...
RUNS = 10
verbose = False
MEDIA = Path("/home/llan/Desktop/WUR/thesis2/media2/binary/optimization5/LRe-4")
...
# model = ComboBreaker(EMBED_SIZE, NUM_GO, NUM_CLASS, COMBINED_SIZE).to("cuda")
...
# models = { 
#     # "TRANSF-Add": Transformer(100, 7247, 2, 200, 2, 2).to("cuda"),
#     # "TRANSF-Conc": Transformer(100, 7247, 2, 600, 2, 2).to("cuda"),
#     "Linear-Add": ComboBreaker(100, 7247, 2, 200).to("cuda"),
#     "Linear-Conc": ComboBreaker(100, 7247, 2, 600).to("cuda"),  
# }

models = {"OPT-MODEL": OptimizationModel(400, 2, 1, 2, "ReLU", 0, False, True).to("cuda")}

comb = product(idx_files.keys(), models.keys())
...
for data_dir, model_name in comb:
