...
RUNS = 10
verbose = False
MEDIA = Path("/home/llan/Desktop/WUR/thesis2/media2/binary/single_g2v_1000/")
...
comb = product(idx_files.keys(), [G2V, GO, EXP])
